...
runs, captures the model digest, source commit, lockfile and binary hashes, and toolchain versions,
and writes raw metrics and responses under ignored `artifacts/ollama/`:
